...
My background combines real-world SQL and ACL control work with hands-on Azure data engineering projects. I am building my next professional step around the point where analytics, data quality and cloud engineering meet: understanding the business rule, implementing it clearly and proving that the result reconciles.

## What I work with

`Oracle SQL` · `Python` · `Azure Data Factory` · `ADLS Gen2` · `Databricks` · `PySpark` · `Spark SQL` · `ACL Analytics` · `Excel`
...
| [ACL + Oracle SQL Billing Controls](https://github.com/hernano88/acl-sql-uade) | Production-oriented billing controls, SQL extraction, ACL processing, reconciliations and explainable monthly coverage. |
...
Mi experiencia combina trabajo real con controles en Oracle SQL y ACL con proyectos prácticos de ingeniería de datos en Azure. Estoy construyendo mi próximo paso profesional en el punto donde se encuentran la analítica, la calidad de datos y la nube: comprender la regla del negocio, implementarla con claridad y demostrar que el resultado concilia.
